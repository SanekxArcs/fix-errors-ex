...
// Loaded via <script> tag in the renderer (defines globals) and via require() in the main process.
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { DEFAULT_PROMPTS, ACTION_LABELS, DEFAULT_GEMINI_MODEL, DEFAULT_LM_STUDIO_URL, GEMINI_MODELS };
}
